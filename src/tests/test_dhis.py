...
from msftoolbox.dhis2.module import Dhis2Metadata, Dhis2DataValues
import requests
import json

def test_Dhis2Metadata_init():
    metadata = Dhis2Metadata(username='user', password='pass', server_url='http://example.com')
    assert metadata.dhis2_username == 'user'
    assert metadata.dhis2_password == 'pass'
    assert metadata.dhis2_server_url == 'http://example.com'

def test_Dhis2Metadata_configure_dhis2_server():
    metadata = Dhis2Metadata(username='user', password='pass', server_url='http://example.com')
...
# Tests for Dhis2DataValues class
...
def test_send_data_values_json(mock_post):
    ...
    datavalues = Dhis2DataValues(username='user', password='pass', server_url='http://example.com')
